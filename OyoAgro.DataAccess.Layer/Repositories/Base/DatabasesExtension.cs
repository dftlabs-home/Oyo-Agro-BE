...
namespace OyoAgro.DataAccess.Layer.Repositories.Base
{
    ...
    {
        // Convert DataReader data to Dynamic objects
        ...
        // Convert IDataReader to Collection
        ...
        //  Convert IDataReader to DataTable
        // <param name="dr"></param>
        // <returns></returns>
        ...
        // Get entity class key value (cache)
        // <typeparam name="T"></typeparam>
        ...
        //This class judges and converts nullable types, otherwise it will report an error
                ...
                try
                {
                    ...
                    switch (parameter.DbType)
                    {
                        ...
                        case DbType.DateTime2:
                            if (parameter.Value != DBNull.Value && parameter.Value is DateTime dt)
                            {
