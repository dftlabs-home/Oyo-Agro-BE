...
namespace OyoAgro.DataAccess.Layer.Helpers
{
    ...
    {
        private static readonly string DESKey = "*change*"; // 8-bit or 16-bit
        private static readonly string DESIv = "1change1"; // 8-bit or 16-bit

        private static readonly string AESKey = "12345dontusethis"; // 16-bit or 32-bit
        private static readonly string AESIv = "youshouldchange!"; // 16-bit or 32-bit
